"""INFINITO_PACKAGE_CACHE_ADMIN_PASSWORD: stable per-host Nexus admin
...
KEY = "INFINITO_PACKAGE_CACHE_ADMIN_PASSWORD"
COMMENT = (
...
def apply(eb: EnvBuilder, ctx: BuildContext) -> None:
    ...
    if existing_pw:
        ...
        return
    seed = f"{eb.get('INFINITO_PACKAGE_CACHE_HOST_PATH')}:{hostname()}"
