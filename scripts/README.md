...
This directory contains automation scripts used across the project.
...
- 📚 Keep script-based workflows discoverable and easier to navigate

The scope of this folder is script organization at the repository level.
Detailed responsibilities belong in the README files of the respective subdirectories.
