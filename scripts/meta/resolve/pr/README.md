...
- `branch_prefix.sh` validates that the PR branch prefix matches the detected scope — see [branch.md](../../../../docs/contributing/flow/branch.md) for the authoritative list of valid prefixes and their CI impact
