...
#   - to $GITHUB_ENV:   INFINITO_TEST_DEPLOY_TYPE, INFINITO_DISTROS, INFINITO_WHITELIST
...
INFINITO_TEST_DEPLOY_TYPE="${INFINITO_TEST_DEPLOY_TYPE:-${INPUT_TEST_DEPLOY_TYPE:-}}" # nocheck: gha-input-bridge
