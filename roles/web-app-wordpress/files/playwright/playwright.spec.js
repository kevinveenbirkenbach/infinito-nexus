...
// -----------------------------------------------------------------------------
// Diagnostics + CSP helpers (copied from web-app-keycloak/files/playwright/playwright.spec.js
...
test("administrator: app → universal logout", async ({ page }) => {
  await runAdminFlow(page, {
    adminInteraction: async (interactivePage) => {
      // web-app-wordpress admin-only interaction: open a management surface.
