...
Integration tests for cross-cutting metadata that describes the project itself: role categories, CLI entrypoints, per-role `config/main.yml` shape, domain declarations, per-role spot checks, and GitHub-side CI/CD artefacts (workflows, Dependabot).
