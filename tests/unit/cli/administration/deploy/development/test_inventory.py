...
(`cli.administration.deploy.development.inventory`)."""
...
class TestResolveVariantPayloads(unittest.TestCase):
    @patch(
        "cli.administration.deploy.development.inventory.get_variants", autospec=True
    )
...
class TestPlanDevInventoryMatrix(unittest.TestCase):
    @patch(
        "cli.administration.deploy.development.inventory._resolve_round_include",
        autospec=True,
    )
    @patch(
        "cli.administration.deploy.development.inventory._build_services_overrides_for_round",
        autospec=True,
        return_value={},
    )
    @patch(
...
class TestBuildDevInventory(unittest.TestCase):
    ...
    @patch(
        "cli.administration.deploy.development.inventory.get_variants",
        autospec=True,
        return_value={
            "web-app-keycloak": [{}],
            "web-app-nextcloud": [{}],
    ...
    @patch(
        "cli.administration.deploy.development.inventory.should_use_mirrors_on_ci",
        autospec=True,
        return_value=False,
    )
    ...
    @patch(
        "cli.administration.deploy.development.inventory.generate_ci_mirrors_file",
        autospec=True,
...
class TestBuildDevInventoryMatrix(unittest.TestCase):
    ...
    @patch(
        "cli.administration.deploy.development.inventory.build_dev_inventory",
        autospec=True,
    )
    @patch(
        "cli.administration.deploy.development.inventory.get_variants",
