...
| 5 | `APPS=web-app-matomo make deploy-fresh-purged-app` | Runs the baseline validation path for one concrete app. For the retry-loop policy, see [Iteration](../../agents/action/iteration.md). |
