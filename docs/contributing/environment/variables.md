...
|---|---|---|---|
| `APP` | Single-app deploy target used by `app.sh`, `rapid.sh`, and purge helpers. | Required for single-app flows. | [app.sh](../../../scripts/tests/deploy/local/app.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [entity.sh](../../../scripts/tests/deploy/local/utils/purge/entity.sh) |
| `DEBUG` | Enables debug behavior in local deploy flows. | Boolean; defaults vary by helper. | [app.sh](../../../scripts/tests/deploy/local/app.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
...
| `INFINITO_CONTAINER` | Name of the running dev container. | `infinito_nexus_${INFINITO_DISTRO}` | [defaults.sh](../../../scripts/meta/env/defaults.sh), [entity.sh](../../../scripts/tests/deploy/local/utils/purge/entity.sh), [inventory.sh](../../../scripts/tests/deploy/local/utils/purge/inventory.sh), [web.sh](../../../scripts/tests/deploy/local/utils/purge/web.sh) |
| `INFINITO_DISTRO` | Selected distro flavor for the dev stack and image tags. | `debian`; accepted values are `arch`, `debian`, `ubuntu`, `fedora`, `centos`. | [defaults.sh](../../../scripts/meta/env/defaults.sh), [all.sh](../../../scripts/tests/deploy/local/all.sh), [app.sh](../../../scripts/tests/deploy/local/app.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
| `INVENTORY_DIR` | Inventory directory used by local deploy helpers. | `$HOME/inventories/localhost` when resolved automatically. | [inventory.sh](../../../scripts/meta/env/inventory.sh), [resolve.sh](../../../scripts/inventory/resolve.sh), [all.sh](../../../scripts/tests/deploy/local/all.sh), [app.sh](../../../scripts/tests/deploy/local/app.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [reset.sh](../../../scripts/tests/deploy/local/utils/reset.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
| `LIMIT_HOST` | Ansible limit pattern for local deploys. | `localhost` | [all.sh](../../../scripts/tests/deploy/local/all.sh), [app.sh](../../../scripts/tests/deploy/local/app.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
| `PYTHON` | Python executable used by helper scripts. | `python3` or the active venv python. | [python.sh](../../../scripts/meta/env/python.sh), [all.sh](../../../scripts/tests/deploy/local/all.sh), [app.sh](../../../scripts/tests/deploy/local/app.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
| `TEST_DEPLOY_TYPE` | Inventory and deploy flavor. | `server`; accepted values are `server`, `workstation`, `universal`. | [defaults.sh](../../../scripts/meta/env/defaults.sh), [input.sh](../../../scripts/meta/resolve/input.sh), [all.sh](../../../scripts/tests/deploy/local/all.sh), [dedicated_distro.sh](../../../scripts/tests/deploy/local/dedicated_distro.sh), [rapid.sh](../../../scripts/tests/deploy/local/rapid.sh), [reset.sh](../../../scripts/tests/deploy/local/utils/reset.sh), [run-all.sh](../../../scripts/tests/deploy/local/run-all.sh) |
| `TEST_PATTERN` | Glob for test discovery. | `test*.py` | [defaults.sh](../../../scripts/meta/env/defaults.sh) |
| `WHITELIST` | Optional app-discovery filter. | Empty by default. | [input.sh](../../../scripts/meta/resolve/input.sh), [all.sh](../../../scripts/tests/deploy/local/all.sh) |
