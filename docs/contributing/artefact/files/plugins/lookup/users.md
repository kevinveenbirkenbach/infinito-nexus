...
| [runtime_lookup_data.py](../../../../../../utils/runtime_lookup_data.py) | Shared aggregation helper that builds and caches defaults, handles reserved users, UID/GID allocation, and uniqueness validation. |
