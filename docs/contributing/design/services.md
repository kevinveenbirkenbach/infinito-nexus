...
See the agent authoring guide for `style.css`: [style.css.md](../../../docs/agents/files/role/style.css.md)
...
See the agent authoring guide for `javascript.js`: [javascript.js.md](../../../docs/agents/files/role/javascript.js.md)
...
## `load_app.yml`: run-once loader ⚙️
...
### `service_should_load`: should this service be loaded for this app? 🔍
