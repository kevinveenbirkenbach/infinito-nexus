...
See [services.md](../code/services.md) for the full service registration, loading, and injection model.
...
- [services.md](../code/services.md) for service registration, loading, and injection
