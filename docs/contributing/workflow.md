...
These rules are enforced via branch protection. See [branch.md](artefact/git/branch.md) for the full policy.
...
2. Create a branch in your fork with the right prefix. See [branch.md](artefact/git/branch.md).
3. Make one focused change at a time.
4. Run the relevant local checks. See [testing.md](actions/testing.md).
5. Push the branch to your fork.
6. Wait until the CI in your fork is green. See [pull-request.md](artefact/git/pull-request.md) for required CI scope.
7. Open a [Pull Request](artefact/git/pull-request.md).
8. Address review feedback in your fork. See [review.md](actions/review.md).
