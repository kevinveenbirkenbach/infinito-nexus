...
- You MUST keep the template surface small and explicit.
- You MUST NOT use `playwright.env.j2` as a general dump for unrelated runtime variables.
- You MUST put the scenario requirements in [Contributing `playwright.spec.js`](playwright.spec.js.md).
